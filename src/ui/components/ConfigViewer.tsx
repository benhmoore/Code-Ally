...
export const ConfigViewer: React.FC<ConfigViewerProps> = ({
  ...
  const categories = useMemo(() => {
    ...
    const categoryDefs = {
      ...
      'UI Preferences': ['theme', 'compact_threshold', 'show_context_in_prompt', 'show_thinking_in_chat', 'show_system_prompt_in_chat', 'show_full_tool_output', 'show_tool_parameters_in_chat'],
