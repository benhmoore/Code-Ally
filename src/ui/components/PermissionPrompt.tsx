...
export const PermissionPrompt: React.FC<PermissionPromptProps> = ({
  ...
  return (
    <InteractiveSurface
      ...
      tone={color}
      meta={queueLength != null && queueLength > 1 ? `${queueLength} pending` : undefined}
      description={autoAllowMode ? 'Auto-allow is on for safe operations.' : undefined}
      footer={<KeyboardHintFooter action="confirm" cancelText="deny" autoAllowMode={autoAllowMode} />}
    >
