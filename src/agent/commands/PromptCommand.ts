...
export class PromptCommand extends Command {
  static readonly metadata: CommandMetadata = {
    ...
    helpCategory: 'Prompts',
    subcommands: [
      { name: 'add', description: 'Create a new prompt' },
      { name: 'edit', description: 'Edit an existing prompt', args: '<id>' },
      { name: 'delete', description: 'Delete a prompt', args: '<id>' },
  ...
  static {
    CommandRegistry.register(PromptCommand.metadata);
  }

  readonly name = PromptCommand.metadata.name;
  readonly description = PromptCommand.metadata.description;
  protected readonly useYellowOutput = PromptCommand.metadata.useYellowOutput ?? false;
